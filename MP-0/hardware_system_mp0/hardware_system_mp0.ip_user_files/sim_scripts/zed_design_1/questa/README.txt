...
#
# Generated by export_simulation on Wed Jan 23 11:08:30 -0600 2019
#
################################################################################
...
'-reset_run' switch to the './zed_design_1.sh' script.

./zed_design_1.sh -reset_run
...
./zed_design_1.sh -noclean_files

For more information on the script, please type './zed_design_1.sh -help'.

...
HD_PWD='U:/cpre488/Labs/MP-0/hardware_system_mp0/hardware_system_mp0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zed_design_1_wrapper.tcl -notrace

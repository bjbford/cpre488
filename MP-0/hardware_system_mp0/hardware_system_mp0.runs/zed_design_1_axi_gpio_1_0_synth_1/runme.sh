...
HD_PWD='U:/cpre488/Labs/MP-0/hardware_system_mp0/hardware_system_mp0.runs/zed_design_1_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_design_1_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zed_design_1_axi_gpio_1_0.tcl

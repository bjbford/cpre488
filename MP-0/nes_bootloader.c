...
void xil_init() {
	...
	XAxiVdma_WriteReg(XPAR_AXIVDMA_0_BASEADDR, XAXIVDMA_MM2S_ADDR_OFFSET + XAXIVDMA_START_ADDR_OFFSET, FBUFFER_BASEADDR);  // Read Channel: VDMA MM2S Frame buffer Start Addr 1

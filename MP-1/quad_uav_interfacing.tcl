...
#
# quad_uav_interfacing.tcl: Tcl script for re-creating project 'quad_uav_interfacing'
#
# Generated by Vivado on Mon Feb 18 13:43:45 -0600 2019
...
#
# 1. This project restoration tcl script (quad_uav_interfacing.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "U:/cpre488/Labs/MP-1/quad_uav_interfacing/quad_uav_interfacing.srcs/sources_1/bd/quad_uav_interfacing/hdl/quad_uav_interfacing_wrapper.vhd"
#    "U:/cpre488/Labs/MP-1/quad_uav_interfacing/archive_project_summary.txt"
#    "U:/cpre488/Labs/MP-1/quad_uav_interfacing/quad_uav_interfacing.srcs/constrs_1/new/MP-1.xdc"
#
...
set _xil_proj_name_ "quad_uav_interfacing"
...
set script_file "quad_uav_interfacing.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/quad_uav_interfacing"]"
...
set files [list \
 [file normalize "${origin_dir}/quad_uav_interfacing/quad_uav_interfacing.srcs/sources_1/bd/quad_uav_interfacing/hdl/quad_uav_interfacing_wrapper.vhd" ]\
 [file normalize "${origin_dir}/quad_uav_interfacing/archive_project_summary.txt" ]\
]
...
set file "hdl/quad_uav_interfacing_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "quad_uav_interfacing_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/quad_uav_interfacing/quad_uav_interfacing.srcs/constrs_1/new/MP-1.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/MP-1.xdc"
...
# Proc to create BD quad_uav_interfacing
proc cr_bd_quad_uav_interfacing { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name quad_uav_interfacing
  ...
  # Create ports
  set PPM_Input [ create_bd_port -dir I PPM_Input ]
  set PPM_Output [ create_bd_port -dir O PPM_Output ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins btns_5bits/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins sws_8bits/S_AXI]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_ppm_0/s00_axi_aresetn] [get_bd_pins btns_5bits/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins sws_8bits/s_axi_aresetn]
  connect_bd_net -net PPM_Input_1 [get_bd_ports PPM_Input] [get_bd_pins axi_ppm_0/PPM_Input]
  connect_bd_net -net axi_ppm_0_PPM_Output [get_bd_ports PPM_Output] [get_bd_pins axi_ppm_0/PPM_Output]
  connect_bd_net -net processing_system7_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_ppm_0/s00_axi_aclk] [get_bd_pins btns_5bits/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7/FCLK_CLK0] [get_bd_pins processing_system7/M_AXI_GP0_ACLK] [get_bd_pins sws_8bits/s_axi_aclk]
  connect_bd_net -net processing_system7_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7/FCLK_RESET0_N]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs axi_ppm_0/S00_AXI/S00_AXI_reg] SEG_axi_ppm_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs btns_5bits/S_AXI/Reg] SEG_btns_5bits_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs sws_8bits/S_AXI/Reg] SEG_sws_8bits_Reg
...
# End of cr_bd_quad_uav_interfacing()
cr_bd_quad_uav_interfacing ""
set_property REGISTERED_WITH_MANAGER "1" [get_files quad_uav_interfacing.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files quad_uav_interfacing.bd ] 
